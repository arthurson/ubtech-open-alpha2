...
public class Alpha2RobotApi implements Alpha2SerialPortOnRcvListener, Alpha2SerialPortHeaderOnRcvListener {
   ...
   /**
    * The 5-mic hardware LED path (header_stop5MicEyeLED / header_stop5MicEarLED /
    * header_ledSetEye5Mic / header_ledSetHead5Mic) has been removed along with
    * getRobotSerialNumber(): re-decompiling this APK's IAlpha2SerialPortService$Stub
    * shows only 5 transactions total, none of which are these. See
    * Alpha2SerialHeaderServiceUtil for the confirmed replacement
    * (sendCommandString(String,int), signature-only, unconfirmed name) that occupies
    * this build's 5th transaction slot instead.
    */
