...
window.ALPHA_BLOCK_I18N = {
  ...
  toolbox_cat_speech:        { zh: '🔊 聲音', en: '🔊 Sound' },
  ...
  page_refresh_music_btn:    { zh: '🔄 取得音樂清單', en: '🔄 Load Music List' },
  ...
  run_music_list_failed:     { zh: '❌ 取得音樂清單失敗', en: '❌ Failed to fetch music list' },
  run_music_list_load_failed_option: { zh: '(載入失敗)', en: '(load failed)' },
