...
function toggleAccelerometer() {
  ...
  return lynxApi("accelerometer/set", { on: String(on) }).then(function (json) {
    if (!json.ok) {
...
// colours, triggering actions, etc) is handled in index.html's inline script.
