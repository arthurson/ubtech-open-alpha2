...
const I18N = {
  ...
  wakeup_track_heading: { zh: "👂 喚醒轉頭", en: "👂 Turn to wake word" },
  wakeup_track_label: { zh: "開＝聽到喚醒詞轉頭望過去", en: "On = turn head toward wake word" },
  wakeup_track_hint: { zh: "全本地引擎（免上網）；同小智咪/串流搶咪，有衝突先關呢個。", en: "Fully on-device (no network); contends for mic with XiaoZhi mic/stream, turn off if conflict." },
