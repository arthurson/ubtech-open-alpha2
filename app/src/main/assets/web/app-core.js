...
const I18N = {
  ...
  vosk_mic_fail_prefix:    { zh: "❌ 咪測試失敗：", en: "❌ Mic test failed: " },
  vosk_mic_loud:           { zh: "夠大聲 ✓", en: "Loud enough ✓" },
  vosk_mic_quiet:          { zh: "細聲，行近啲講", en: "Quiet, move closer" },
  vosk_mic_silent:         { zh: "太靜／無聲，查咪", en: "Too quiet/silent, check mic" },
  vosk_ep_label:           { zh: "收音延遲：", en: "Endpointing:" },
  vosk_ep_default:         { zh: "跟預設", en: "Default" },
  vosk_ep_short:           { zh: "短", en: "Short" },
  vosk_ep_long:            { zh: "長", en: "Long" },
  vosk_ep_verylong:        { zh: "很長", en: "Very long" },
  ...
  radio_browser_hint:          { zh: "全球公開電台：搜尋即列出 50 個隨機結果，撳名即播", en: "Worldwide public stations: search lists 50 random results, tap a name to play" },
  ...
  arc_hint:                    { zh: "Internet Archive 免費音樂（現場／獨立／舊錄音），唔使 login；搜尋經你個瀏覽器，播放經機械人。", en: "Free music from Internet Archive (live/indie/vintage), no login; search runs in your browser, playback on the robot." },
  arc_search_placeholder:      { zh: "搜尋歌名、歌手、樂隊…",    en: "Search song, artist or band…" },
  arc_search_btn:              { zh: "🔍 搜尋",                en: "🔍 Search" },
  arc_search_no_result:        { zh: "未搵到，試下其他關鍵字",    en: "Nothing found — try another keyword" },
  arc_search_found_suffix:     { zh: " 隻碟，撳入去揀歌",        en: " albums — tap one to pick a track" },
  arc_no_mp3:                  { zh: "呢隻碟無 MP3，揀過另一隻",   en: "No MP3 in this album — pick another" },
  arc_play_fail_prefix:        { zh: "❌ 播放失敗（機械人可能上唔到網）：", en: "❌ Play failed (robot may be offline): " },
