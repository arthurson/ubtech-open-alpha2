...
// 呢個檔案係由原本單一嘅 app.js 拆出嚟嘅其中一份, 內容: 全局狀態、UI 語言字典、servo 校準表、backend switch、api()/lynxApi()/hwApi() 呢啲所有其他 app-*.js 都要用嘅核心 helper。呢個檔案要第一個 load。
...
const I18N = {
  ...
  xiaozhi_phase2_hint:        { zh: "文字對話 + 語音對話（Opus）已接通。語音功能需要 Android 5.0（API 21）或以上。",
                                 en: "Text chat + voice chat (Opus) are wired up. Voice requires Android 5.0 (API 21) or newer." },
  ...
  xiaozhi_url_placeholder:    { zh: "wss://api.xiaozhi.me/v1/", en: "wss://api.xiaozhi.me/v1/" },
  xiaozhi_token_placeholder:  { zh: "Access Token",         en: "Access Token" },
  xiaozhi_connect:            { zh: "連接",                 en: "Connect" },
  xiaozhi_disconnect:         { zh: "斷開",                 en: "Disconnect" },
  ...
  xiaozhi_missing_url_or_token: { zh: "請先輸入伺服器網址同 Access Token", en: "Please enter both the server URL and Access Token" },
  xiaozhi_mic_start:          { zh: "🎤 開始語音對話",        en: "🎤 Start Voice Chat" },
  xiaozhi_mic_stop:           { zh: "⏹ 停止語音對話",        en: "⏹ Stop Voice Chat" },
  xiaozhi_mic_idle:           { zh: "未開始",               en: "Idle" },
  xiaozhi_mic_active:         { zh: "🔴 語音對話中…",        en: "🔴 Voice chat active…" },
  xiaozhi_mic_error:          { zh: "語音啟動失敗",          en: "Failed to start voice chat" },
