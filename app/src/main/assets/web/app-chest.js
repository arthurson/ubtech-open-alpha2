...
function chestUpload() {
  ...
  reader.onload = function(e) {
    ...
    // 同 api() 系列一樣由 localStorage 拿，不用經 Alpha2Api（upload 行 raw fetch）。
...
function chestCheck() {
  ...
  Alpha2Api.chestVersion().then(function(json) {
