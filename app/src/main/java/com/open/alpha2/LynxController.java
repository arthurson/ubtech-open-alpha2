 ...
 *
 * Mirrors the dispatch style of the API handler (same
 ...
 *
 * Unlike LynxRobotApi used to need no explicit initXxxApi()/bind step - every
...
public class LynxController {
     ...
     *  test tone) and go through neither LynxRobotApi - the same
