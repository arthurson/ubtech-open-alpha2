 ...
 * methods on the robot SDK, confirmed against SDK source), this class does NOT wrap any
 * AIDL method - there is no such thing as "mouth LED" in the AIDL
 ...
 * libhead_led.so via JNI, bypassing AIDL entirely. This is a
