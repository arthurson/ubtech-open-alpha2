...
public class MainActivity extends Activity {
    ...
    private HttpServer.ApiResponse handleApi(String path, Map<String, String> query, String method, String body) {
        switch (path) {
            ...
            // led/head/set and led/eye/set have been removed: they called
            // Alpha2RobotApi.header_stop5MicEarLED/header_stop5MicEyeLED/
            // header_ledSetHead5Mic/header_ledSetEye5Mic, none of which exist in this
            // APK's IAlpha2SerialPortService (re-decompiled Stub has 5 transactions
            // total, none matching these). See Alpha2RobotApi's javadoc at the removed
            // 5-mic LED section for details.
            //
            // NOTE: unlike the removed led/head/set and led/eye/set above, this does NOT go through
