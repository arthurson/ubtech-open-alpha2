...
interface IAlpha2SerialPortService {
    ...
    // build: transaction ids 4-8, in this exact order. Order here MUST match the
    // on-robot service or calls will hit the wrong native method.
    boolean stop5MicEyeLED();                                                        // id 4
    boolean stop5MicEarLED();                                                        // id 5
    boolean ledSetEye5Mic(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8); // id 6
    boolean ledSetHead5Mic(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8); // id 7
    String getRobotSerialNumber();                                                   // id 8
}
