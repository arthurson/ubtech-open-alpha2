...
public class DeveloperAngle {
   ...
   private static final int[][] LIMITS = {
      ...
      // app-core.js 的 SERVO_CALIBRATION[11] 對齊 - 前端那個 100 才是正確的實測
      // 硬體校準值 (10 是這裡舊有、過時的數字)。這個差異之前不會造成安全問題
      // (前端已經用更保守的 100 做下限, clamp 完的結果一定都還在這裡舊的
      // [10,190] 範圍之內), 但 Advanced tab 的 raw AIDL passthrough 只靠
      // 這個底層表做防線、不經前端 clamp, 所以兩份數字理應同步。
      {100, 190}, // 10
      {40, 140},  // 11
      {20, 220},  // 12
      {10, 205},  // 13
